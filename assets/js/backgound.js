...
function meshBackground() {
  ...
  Point.prototype.step = function () {
    this.x =
      this.xBase +
      this.dir * Math.sin((tick + this.offset) / this.duration) * this.range;
    this.y =
      this.yBase +
      this.dir * Math.cos((tick + this.offset) / this.duration) * this.range;
  ...
  function mousemove(e) {
    mouseMoved = true;
    console.log("mouse-moving1" + JSON.stringify(e));
    mouse.x = e.pageX;
    mouse.y = e.pageY;
  }
...
function abstractBackground() {
  ...
  function onMouseMove(event) {
    console.log("mouse-moving3" + JSON.stringify(event));
...
function sphereBackground() {
  ...
  function onDocumentMouseMove(event) {
    console.log("mouse-moving5" + JSON.stringify(e));
...
function demo_only() {
  ...
  if (searchParams.has("bg"))
    option_hero_background_mode = searchParams.get("bg");
} //demo_only();
