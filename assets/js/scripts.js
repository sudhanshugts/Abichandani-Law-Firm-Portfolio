...
function section_system() {
      ...
      $(this)
        ...
        .each(function () {
          ...
          if ($(this).hasClass("text-splitt")) {
            ...
            animation_data = animation_data.from(
              splitt_data[type],
              settings,
              0
            );
    ...
    switch (options.section_animation) {
      case "slide":
        if (direction == "next") {
          ...
          tl_next.to(sections.eq(current_section), {
            ease: options.section_animation_ease,
            duration: options.section_animation_duration,
            y: "-100%",
          });
          tl_next.to(sections.eq(upcoming_section), {
            ease: options.section_animation_ease,
            duration: options.section_animation_duration,
            y: "0%",
            delay: -(options.section_animation_duration + 0.005),
          });
        }

        if (direction == "prev") {
          tl_prev.set(sections.eq(upcoming_section), { y: "-100%" });
          tl_prev.to(sections.eq(current_section), {
            ease: options.section_animation_ease,
            duration: options.section_animation_duration,
            y: "100%",
          });
          tl_prev.to(sections.eq(upcoming_section), {
            ease: options.section_animation_ease,
            duration: options.section_animation_duration,
            y: "0%",
            delay: -(options.section_animation_duration + 0.005),
      ...
      case "fade":
        if (direction == "next") {
          ...
          tl_next.to(sections.eq(upcoming_section), {
            ...
            duration: options.section_animation_duration,
            opacity: 1,
            delay: -options.section_animation_duration,
          });
        }
      ...
      case "parallax":
        if (direction == "next") {
          tl_next.set(sections.eq(upcoming_section), {
            y: "100%",
            opacity: 1,
            zIndex: 2,
          });
        ...
        if (direction == "prev") {
          tl_prev.set(sections.eq(upcoming_section), {
            y: "-100%",
            opacity: 1,
            zIndex: 2,
          });
  ...
  function update_timeline(type) {
    ...
    if (
      !sections.eq(current_section).hasClass("content-animation-played") ||
      options.replay_content_animations == true
    ) {
    ...
    if (type == "next") {
      ...
      tl_next.add(function () {
        ...
        if (
          !sections.eq(upcoming_section).hasClass("content-animation-played") ||
          options.replay_content_animations == true
        ) {
          tl_content.add(function () {
  ...
  //   const anahita = document.querySelector("#name");
  //   anahita.addEventListener("click", (e) => {
  //     const find = e.target.innerHTML;
  //     console.log(find);
  //     update_section(1);
  //   });
...
function lightbox_setup() {
  var customLightboxHTML =
    '<div id="glightbox-body" class="glightbox-container hide-nav">' +
...
function form_setup() {
  ...
  $("#contact-form").submit(function (e) {
    ...
    for (var count = 0; count < pD_el_count; count++) {
      if (
        $("#contact-form input[name='" + postdata[count].name + "']").attr(
