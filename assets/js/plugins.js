...
!(function (e, t) {
  ...
  function a(e) {
    ...
    return (
      T(g) && (g = document.querySelectorAll(g)),
      (v.destroy = function () {
        o(g, function (t) {
          var i = r(t, e, v);
  ...
  function A(t) {
    return "object" === e(t) && null != t && !w(t) && !C(t);
  }
  function L(e) {
    return null == e;
  }
      ...
      b(this.settings.plyr.js, "Plyr", function () {
        ...
        if (null !== c.match(/\.(mp4|ogg|webm|mov)$/)) {
          ...
          var p = c.toLowerCase().split(".").pop(),
            y = { mp4: "", ogg: "", webm: "" };
          for (var b in ((y[(p = "mov" == p ? "mp4" : p)] = c), y))
        ...
        var k = I(s.settings.plyr, "config") ? s.settings.plyr.config : {},
          C = new Plyr("#" + o, k);
        C.on("ready", function (e) {
          ...
          C.on("enterfullscreen", H),
          C.on("exitfullscreen", H);
      });
  }
  function H(e) {
        ...
        n(e, [
          {
            ...
            value: function () {
              ...
              var o = s.type,
                r = s.descPosition,
                d = t.querySelector(".gslide-media"),
                u = t.querySelector(".gslide-title"),
                g = t.querySelector(".gslide-desc"),
                v = t.querySelector(".gdesc-inner"),
                f = i,
              ...
              if (
                ...
                "" == s.title && "" == s.description
                  ? v && v.parentNode.parentNode.removeChild(v.parentNode)
                  : (u && "" !== s.title
                      ? ((u.id = p), (u.innerHTML = s.title))
                      : u.parentNode.removeChild(u),
                    g && "" !== s.description
                      ? ((g.id = y),
                        l && n.moreLength,
                        (g.innerHTML = s.description))
                      : g.parentNode.removeChild(g),
                    h(d.parentNode, "desc-".concat(r)),
                    h(v.parentNode, "description-".concat(r))),
                h(d, "gslide-".concat(o)),
                h(t, "loaded"),
                "video" !== o)
              ) {
                    ...
                    : void ("image" !== o
                        ...
                        : (function (e, t, i, n) {
                            ...
                            l.addEventListener(
                              ...
                              (l.alt = ""),
                              "" !== t.title &&
                                l.setAttribute("aria-labelledby", o),
                              "" !== t.description &&
                                l.setAttribute("aria-describedby", r),
                ...
                V.apply(this, [t, s, this.index, f]);
              } else W.apply(this.instance, [t, s, this.index, f]);
            },
          },
          {
            key: "slideShortDesc",
        ...
        n(e, [
          ...
          },
          {
            ...
            value: function () {
              ...
              var n = I(this.settings.svg, "next")
                  ? this.settings.svg.next
                  : "",
                s = I(this.settings.svg, "prev") ? this.settings.svg.prev : "",
                l = I(this.settings.svg, "close")
            ...
            value: function () {
              ...
              if ((e = e || this.activeSlide) && !c(e, "zoomed")) {
                ...
                if (
                  ...
                  if (i) {
                    var g = I(this.settings.plyr.config, "ratio")
                    ...
                    if (
                      ...
                      (i.parentNode.style.maxWidth = "".concat(b)),
                        r &&
                          s.setAttribute("style", "max-width: ".concat(b, ";"));
                  }
                }
              }
            },
